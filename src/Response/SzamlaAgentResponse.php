...
namespace zoparga\SzamlazzHuSzamlaAgent\Response;
...
use zoparga\SzamlazzHuSzamlaAgent\Header\InvoiceHeader;
use zoparga\SzamlazzHuSzamlaAgent\Log;
use zoparga\SzamlazzHuSzamlaAgent\SimpleXMLExtended;
use zoparga\SzamlazzHuSzamlaAgent\SzamlaAgent;
...
class SzamlaAgentResponse
{
    ...
    {
        $pdfFileName = $this->getDocumentNumber();
